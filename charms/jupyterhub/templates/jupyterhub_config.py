...
if all([keycloak_url, oidc_client_secret]):
    ...
    os.environ['OAUTH2_TOKEN_URL'] = f"{keycloak_url}/realms/charmed-hpc/protocol/openid-connect/token"
    os.environ['OAUTH2_AUTHORIZE_URL'] = f"{keycloak_url}/realms/charmed-hpc/protocol/openid-connect/auth"
    os.environ['OAUTH2_USERDATA_URL'] = f"{keycloak_url}/realms/charmed-hpc/protocol/openid-connect/userinfo"
